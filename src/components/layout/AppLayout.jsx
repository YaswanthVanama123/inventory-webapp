            ...
            <div className="md:hidden border-t border-gray-200 py-4 space-y-2">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-2">
                ...
                <Link
                  to="/register"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors text-center"
                >
                  Get Started
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/roadmap" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                    Roadmap
                  </Link>
                </li>
                <li>
                  <Link to="/changelog" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                    Changelog
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/licenses" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                    Licenses
                  </Link>
                </li>
              </ul>
