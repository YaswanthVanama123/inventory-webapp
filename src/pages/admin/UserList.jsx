                  ...
                  <tbody className="bg-white divide-y divide-slate-200">
                    {paginatedUsers.map((user) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-slate-900">{user.email || 'N/A'}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <Badge variant={getStatusBadgeVariant(user.isActive)} dot>
                            {user.isActive ? 'Active' : 'Inactive'}
                          </Badge>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-slate-900">{formatDate(user.lastLogin)}</div>
                        </td>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-slate-900 truncate ml-2">{user.email || 'N/A'}</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <Badge variant={getStatusBadgeVariant(user.isActive)} size="sm" dot>
                          {user.isActive ? 'Active' : 'Inactive'}
                        </Badge>
                      </div>
                      <div className="flex items-center justify-between text-sm">
